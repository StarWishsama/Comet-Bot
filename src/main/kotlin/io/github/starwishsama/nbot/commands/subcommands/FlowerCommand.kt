                ...
                "gm", "rename", "改名" -> {
                    if (user.flower != null) {
                        if (args.size == 2) {
                            ...
                            BotUtil.sendLocalMessage("msg.bot-prefix", "成功改名为 ${args[1]}").toMirai()
                        } else {
                            getHelp().toMirai()
                        }
                    } else {
                    ...
                    if (flower != null) {
                        when (flower.waterCount) {
                            200 -> {
                                ...
                                BotUtil.sendLocalMessage("msg.bot-prefix", "成功收集 $point 点积分, 水量剩余 ${flower.waterCount}").toMirai()
                            }
                            in 100 until 200 -> {
                            ...
                            in 1 until 50 -> {
                                ...
                                BotUtil.sendLocalMessage("msg.bot-prefix", "你的花需要浇水了! 水壶可以在商店里购买.").toMirai()
                            }
                        }
                    } else {
                        BotUtil.sendLocalMessage("msg.bot-prefix", "你还没有种植花朵").toMirai()
