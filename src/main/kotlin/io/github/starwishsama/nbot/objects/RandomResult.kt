...
import io.github.starwishsama.nbot.enums.EventRate
import java.text.NumberFormat


class RandomResult constructor(var id: Long, var chance: Double, var eventName: String){
    fun getChance(eventName: String, chance: Double): String {
    ...
    fun getChance(result: RandomResult?): String? {
        if (result != null) {
            ...
            nf.maximumIntegerDigits = 3
            nf.minimumFractionDigits = 2
            val chance: Double = result.chance
            return getChance(result.eventName, chance)
        }
        return null
    }
}