                ...
                if (args.size() > 0) {
                    try {
                        ...
                        if (banQQ != -1000) {
                            ...
                            reply = BotUtils.getLocalMessage("msg.bot-prefix") + "该群成员不存在!";
                    } catch (NumberFormatException e) {
                        reply = BotUtils.getLocalMessage("msg.bot-prefix") + "命令格式有误! 用法: /mute [@/QQ号] [dhm]";
                    }
                } else
                    reply = BotUtils.getLocalMessage("msg.bot-prefix") + "用法: /禁 [QQ/@] <时间>";
            } else
