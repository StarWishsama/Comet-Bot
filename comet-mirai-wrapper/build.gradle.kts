...
dependencies {
    ...
    implementation("net.mamoe:mirai-core:2.13.0-dev-dc6f5905")
    implementation("net.mamoe:mirai-core-api:2.13.0-dev-dc6f5905")
    implementation("net.mamoe:mirai-core-utils:2.13.0-dev-dc6f5905")
}
